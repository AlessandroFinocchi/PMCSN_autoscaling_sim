...
public class ExperimentBaseTransient implements Experiment {
    ...
    public List<RunConfiguration> getRunConfigurations() {
        ...
        setConfiguration(7, 10, 0.4, 16,8, false, null);
    ...
    void setConfiguration(int index, double lambda, double z, double cv, int wsNumber, boolean ssActive, Double siMax) {
        RunConfiguration c = result.get(index - 1);
        c.put("distribution.arrivals.mu", String.valueOf(1.0 / lambda));
        c.put("distribution.arrivals.cv", String.valueOf(1.0 / lambda));
