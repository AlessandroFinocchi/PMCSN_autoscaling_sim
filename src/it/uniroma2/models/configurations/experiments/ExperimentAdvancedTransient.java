...
public class ExperimentAdvancedTransient implements Experiment {
    ...
    public List<RunConfiguration> getRunConfigurations() {
        ...
        exp0Pars.add(new Parameter("infrastructure.start_num_server").addValues("5", "10"));
        ...
        exp0Pars.add(new Parameter("webserver.response_time.in_thr").addValues("0"));
        exp0Pars.add(new Parameter("webserver.response_time.out_thr").addValues("INFINITY"));
        ...
        exp1Pars.add(new Parameter("webserver.response_time.in_thr")
