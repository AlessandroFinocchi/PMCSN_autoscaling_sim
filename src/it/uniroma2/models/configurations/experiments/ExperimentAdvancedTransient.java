...
public class ExperimentAdvancedTransient implements Experiment {
    ...
    public List<RunConfiguration> getRunConfigurations() {
        ...
        // commonPars.add(new Parameter("infrastructure.response_time_slo").addValues("2", "5", "10", "20"));
        commonPars.add(new Parameter("infrastructure.response_time_slo").addValues("5"));
        ...
        exp1Pars.add(new Parameter("webserver.scaling.out_thr")
                // .addValues( "0.1", "0.25", "0.5", "1", "2", "3", "4", "5", "8", "10", "20"));
                .addValues( "0.1", "0.5", "2", "4", "8", "20"));
        exp1Pars.add(new Parameter("infrastructure.spikeserver.active").addValues("false"));
        ...
        for (RunConfiguration c : result){
            double mu = Double.parseDouble(c.get("distribution.arrivals.mu"));
            c.put("distribution.services.z", String.valueOf(4.0 * mu));
        }
