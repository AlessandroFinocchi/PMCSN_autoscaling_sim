package it.uniroma2.libs.others;/* --------------------------------------------------------------------------
 ...
 *
 * Name              : it.uniroma2.libs.others.Rvgs.java  (Random Variate GeneratorS)
...
public class Rvgs{
    ...
    //
    // There is no good way to use it.uniroma2.libs.others.Rvgs along with selectStream because the
    // original implementation had the it.uniroma2.libs.others.Rvgs constructor create its own copy
    // of an Rngs object.
    //
    // Instead, force the it.uniroma2.libs.others.Rvgs constructor to have an already-created Rngs
    // object.

    Rngs rngs;
    
//    public it.uniroma2.libs.others.Rvgs(){
//   	  rngs = new Rngs();
//    }
    ...
    public Rvgs(Rngs givenRngs)
    {
      try {
        ...
        System.out.println("it.uniroma2.libs.others.Rvgs constructor requires non-null argument");
      }
      rngs = givenRngs;
    }
    /* Barry Lawson 8 Nov 2007 */
